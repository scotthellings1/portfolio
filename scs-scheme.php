    ...
    <div class="flex">
      ...
      <main>
        ...
        <div class="container scs">
          <h1 class="text-xl my-14">SCS Scheme</h1>
          <div class="row">
            <div class="scs-card col-12 md-col-8 mb-10 p-8 border-accent">
              <h2 class="text-md">Introduction</h2>
            ...
            <div class="scs-card col-12 md-col-4 mb-10 p-8 mr-10 border-accent">
              <div class="nm-logo">
                <img src="img/nm-logo.png" alt="netmatters logo" />
              </div>
              <h2 class="text-md">About Netmatters</h2>
              <ul class="list">
            ...
            <div class="scs-card col-12 md-col-4 mb-10 p-8 border-accent">
              <svg
                alt="treehouse logo"
                class="treehouse-icon"
              ...
              <h2 class="text-md">Treehouse</h2>
              <p class="mb-6">
                Treehouse is an online learning community, featuring videos
                covering a number of topics from basic HTML to C# programming,
                iOS development, data analysis, and more.
              </p>
              <p class="mb-6">
                By completing courses users can earn points, allowing them to
                track their progress and see how much they've covered in certain
                areas.
              </p>
              <p class="mb-6">My Treehouse score is: <span class="treehouse-points"></span><br> Total badges earnt: <span
              class="treehouse-total-badges"></span></p>
              <a
                href="https://teamtreehouse.com/scotthellings2"
                class="link"
                target="_blank"
              >
                My Treehouse Profile</a
              >
            </div>
          </div>
          <div class="row">
          <div class="scs-card col-12 md-col-8 mb-10 p-8 border-accent">
            <h2 class="text-md">Latest Treehouse Badges</h2>
            <div class="">
